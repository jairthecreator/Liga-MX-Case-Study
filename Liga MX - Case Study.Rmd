...
library(lubridate)
library(tidyr)
library(ggimage)  # For adding logos
```

## Dataset Info

This dataset was obtained in Kaggle created by Gerardo Jaime Escareño.  
It can be found here [link](https://www.kaggle.com/datasets/gerardojaimeescareo/ligamx-matches-2016-2022?resource=download).
